...
public class LoginStepsDef {
    ...
    public void valido_que_el_item_agregado_se_llame(String nombreProducto) {
        String tittle = inventorySteps(driver).nameProduct();
        Assertions.assertEquals(nombreProducto, tittle);
    }
